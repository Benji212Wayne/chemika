...
<html>
<head>
<title>Chemika Karya - Kategori</title>
<!-- for-mobile-apps -->
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 0819 1594 5870</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Chemika Karya</a></h1>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<h3>Hubungi Kami</h3>
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Chemika Karya, Perumahan Lingkar Muslim Blok D 02 Cordova Bajur Lombok Barat</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ChemikaKarya@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>0819 1594 5870</li>
					</ul>
				</div>
